...
$breadcrumb->append_crumb("AVIATION DATA", "#");
...
echo "<div class='panel'>
		...
		<div class='panel-page'>
		  	...
		  	<div class='panel-info'>
			  	<div class='title pull-left'>AVIATION DATA</div>
			</div>
			<div class='separator'></div>
			
			<button type='button' class='btn btn-success pull-left' onclick=\"window.location.href='index.php?page=aviation&act=new'\"><i class='icon-plus icon-white'></i> NEW</button>
			
			<table id='dt-aviation' class='table table-bordered table-condensed table-striped table-hover'>
		      	<thead>
				  	<tr>
