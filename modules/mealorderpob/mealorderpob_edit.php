...
if ($_SESSION["user_privilege"] == "ADMINISTRATOR" or $_SESSION["user_privilege"] == "ORDER CENTER") {
	...
	if ($row > 0) {
		...
		$breadcrumb->append_crumb("DETAIL MEAL ORDER & P.O.B", "index.php?page=mealorderpob&act=detail&date=".$date);
		$breadcrumb->append_crumb("EDIT MEAL ORDER & P.O.B", "#");
				...
				<div class='panel-label'>MEAL ORDER & P.O.B ENTRY</div>
			  	<div class='panel-page'>
				  	...
				  	<div class='panel-info'>
					  	<div class='title pull-left'>EDIT FINAL MEAL ORDER & P.O.B</div>
					...
					<div class='form-horizontal'>
		                ...
		                <div class='pull-left'>
	            			<button type='button' class='btn btn-inverse' onclick=\"window.location.href='index.php?page=mealorderpob&act=detail&date=".$date."';\"><i class='icon-arrow-left icon-white'></i> BACK</button>&nbsp;&nbsp;&nbsp;
	            			<button type='button' class='btn btn-success' onclick=\"NewMealOrderPOB()\"><i class='icon-plus icon-white'></i> ADD</button>
	            		</div>
	            		
						<table id='dt-mealorderpob-edit' class='table table-bordered table-condensed table-striped table-hover'>
							<thead>
							  	<tr>
	    ...
	    <div id='modal-mealorderpob-edit' class='modal hide fade form' tabindex='-1' role='dialog' aria-hidden='true' data-backdrop='static' data-keyboard='false'>
		  	<div class='modal-header'>
				<button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>
				<h4>FINAL MEAL ORDER & P.O.B</h4>
			</div>
			<form id='form-mealorderpob-edit'>
