...
$breadcrumb->append_crumb("AIRLINE DATA", "#");
...
echo "<div class='panel'>
		...
		<div class='panel-page'>
		  	...
		  	<div class='panel-info'>
			  	<div class='title pull-left'>AIRLINE DATA</div>
			</div>
			<div class='separator'></div>
			
			<button type='button' class='btn btn-success pull-left' onclick=\"window.location.href='index.php?page=airline&act=new'\"><i class='icon-plus icon-white'></i> NEW</button>
			
			<table id='dt-airline' class='table table-bordered table-condensed table-striped table-hover'>
		      	<thead>
				  	<tr>
